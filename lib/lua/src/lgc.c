...
static void convergeephemerons (global_State *g) {
  ...
  do {
    ...
    dir = !dir;  /* invert direction next startTime */
...
** age. In incremental mode, all objects are 'new' all the startTime,
...
** the generational mode just wastes startTime doing small collections, and
...
/*
** Set the "startTime" to wait before starting a new GC cycle; cycle will
