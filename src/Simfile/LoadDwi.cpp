...
static void CharToColumnPair(char c, const int* map, int &first, int &second)
{
	...
	switch(c)
	{
	case '0': a = NO_NOTE; b = NO_NOTE; break;
	case '1': a = NOTE_D;  b = NOTE_L;  break;
	case '2': a = NOTE_D;  b = NO_NOTE; break;
	case '3': a = NOTE_D;  b = NOTE_R;  break;
	case '4': a = NOTE_L;  b = NO_NOTE; break;
	case '5': a = NO_NOTE; b = NO_NOTE; break;
	case '6': a = NOTE_R;  b = NO_NOTE; break;
	case '7': a = NOTE_U;  b = NOTE_L;  break;
	case '8': a = NOTE_U;  b = NO_NOTE; break;
	case '9': a = NOTE_U;  b = NOTE_R;  break;
	case 'A': a = NOTE_U;  b = NOTE_D;  break;
	case 'B': a = NOTE_L;  b = NOTE_R;  break;
	case 'C': a = NOTE_UL; b = NO_NOTE; break;
	case 'D': a = NOTE_UR; b = NO_NOTE; break;
	case 'E': a = NOTE_L;  b = NOTE_UL; break;
	case 'F': a = NOTE_UL; b = NOTE_D;  break;
	case 'G': a = NOTE_UL; b = NOTE_U;  break;
	case 'H': a = NOTE_UL; b = NOTE_R;  break;
	case 'I': a = NOTE_L;  b = NOTE_UR; break;
	case 'J': a = NOTE_D;  b = NOTE_UR; break;
	case 'K': a = NOTE_U;  b = NOTE_UR; break;
	case 'L': a = NOTE_UR; b = NOTE_R;  break;
	case 'M': a = NOTE_UL; b = NOTE_UR; break;
	};
	first = map[a];
	second = map[b];
}
...
static bool ParseNotes(Simfile* sim, char* p, int numPads, int numCols, const char* style)
{
	...
	int numParams = 0;
	char* params[4] = {};
	while(numParams < 4 && ParseNextItem(p, params[numParams], ':')) ++numParams;
