// Based on the general purpose FFT routines from Ooura's Mathematical Software
// Packages (copyright Takuya OOURA, 1996-2001).
...
-------- Real DFT / Inverse of Real DFT --------
        ...
        [parameters]
                ...
                ip[0...*]	  :work area for bit reversal (int *)
                                        ...
                                        ip[0],ip[1] are pointers of the cos/sin
table. w[0...n/2-1]   :cos/sin table (real *) w[],ip[] are initialized if ip[0]
== 0.
*/
...
static void cft1st(int n, real *a, real *w) {
    int j, k1;
    real wn4r, wtmp, wk1r, wk1i, wk2r, wk2i, wk3r, wk3i, wk4r, wk4i, wk5r, wk5i,
        wk6r, wk6i, wk7r, wk7i;
