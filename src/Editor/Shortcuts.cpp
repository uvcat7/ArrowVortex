    ...
    E(FILE_OPEN) E(FILE_SAVE) E(FILE_SAVE_AS) E(FILE_CLOSE)
        ...
        E(OPEN_DIALOG_SONG_PROPERTIES) E(OPEN_DIALOG_CHART_PROPERTIES) E(
            ...
            E(OPEN_DIALOG_ADJUST_TEMPO) E(OPEN_DIALOG_ADJUST_TEMPO_SM5) E(
                ...
                E(OPEN_DIALOG_TEMPO_BREAKDOWN) E(OPEN_DIALOG_WAVEFORM_SETTINGS) E(
                    OPEN_DIALOG_CUSTOM_SNAP) E(OPEN_DIALOG_ZOOM)
                                                                                                                                                    ...
                                                                                                                                                    E(VOLUME_DECREASE) E(
                                                                                                                                                        ...
                                                                                                                                                        E(SPEED_RESET) E(
                                                                                                                                                            ...
                                                                                                                                                            E(SPEED_DECREASE)
                                                                                                                                                                ...
                                                                                                                                                                E(
                                                                                                                                                                    TOGGLE_BEAT_TICK) E(TOGGLE_NOTE_TICK)

                                                                                                                                                                    E(TOGGLE_SHOW_WAVEFORM) E(TOGGLE_SHOW_BEAT_LINES) E(TOGGLE_SHOW_NOTES) E(TOGGLE_SHOW_TEMPO_BOXES) E(TOGGLE_SHOW_TEMPO_HELP) E(TOGGLE_REVERSE_SCROLL) E(
                                                                                                                                                                        TOGGLE_CHART_PREVIEW)

                                                                                                                                                                        E(MINIMAP_SET_NOTES) E(
                                                                                                                                                                            MINIMAP_SET_DENSITY)

                                                                                                                                                                            E(BACKGROUND_HIDE)
                                                                                                                                                                                E(BACKGROUND_INCREASE_ALPHA)
                                                                                                                                                                                    E(
                                                                                                                                                                                        BACKGROUND_DECREASE_ALPHA) E(BACKGROUND_SET_STRETCH) E(BACKGROUND_SET_LETTERBOX) E(BACKGROUND_SET_CROP)

                                                                                                                                                                                        E(USE_TIME_BASED_VIEW)
                                                                                                                                                                                            E(USE_ROW_BASED_VIEW)

                                                                                                                                                                                                E(
                                                                                                                                                                                                    ZOOM_RESET) E(ZOOM_IN) E(ZOOM_OUT) E(SCALE_INCREASE) E(SCALE_DECREASE)

                                                                                                                                                                                                    E(SNAP_RESET)
                                                                                                                                                                                                        E(SNAP_NEXT)
                                                                                                                                                                                                            E(SNAP_PREVIOUS)

                                                                                                                                                                                                                E(CURSOR_UP) E(CURSOR_DOWN) E(CURSOR_PREVIOUS_BEAT) E(CURSOR_NEXT_BEAT) E(
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        E(CURSOR_STREAM_START)
                                                                                                                                                                                                                            E(CURSOR_STREAM_END)
                                                                                                                                                                                                                                E(CURSOR_SELECTION_START)
                                                                                                                                                                                                                                    E(
                                                                                                                                                                                                                                        CURSOR_SELECTION_END) E(CURSOR_CHART_START)
                                                                                                                                                                                                                                        E(CURSOR_CHART_END)

                                                                                                                                                                                                                                            E(TOGGLE_STATUS_CHART)
                                                                                                                                                                                                                                                E(TOGGLE_STATUS_SNAP) E(TOGGLE_STATUS_BPM) E(TOGGLE_STATUS_ROW) E(TOGGLE_STATUS_BEAT) E(
                                                                                                                                                                                                                                                    TOGGLE_STATUS_MEASURE) E(TOGGLE_STATUS_TIME) E(TOGGLE_STATUS_TIMING_MODE)

                                                                                                                                                                                                                                                    E(
                                                                                                                                                                                                                                                        SHOW_SHORTCUTS) E(SHOW_MESSAGE_LOG)
                                                                                                                                                                                                                                                        E(SHOW_DEBUG_LOG)
                                                                                                                                                                                                                                                            E(SHOW_ABOUT)
#undef E
