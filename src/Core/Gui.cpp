...
void GuiMain::setClipboardFunctions(ClipboardGetFunction get, ClipboardSetFunction set)
{
...
void GuiMain::setCursorIcon(Cursor::Icon icon)
{
	GUI->cursorIcon = icon;
}

Cursor::Icon GuiMain::getCursorIcon()
{
...
bool GuiMain::isCapturingMouse()
{
	return GuiManager::isCapturingMouse();
}

bool GuiMain::isCapturingText()
{
	return GuiManager::isCapturingText();
}
